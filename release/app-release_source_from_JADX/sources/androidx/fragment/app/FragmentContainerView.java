...
public final class FragmentContainerView extends FrameLayout {
    ...
    FragmentContainerView(Context context, AttributeSet attributeSet, FragmentManager fragmentManager) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0232R.styleable.FragmentContainerView);
        if (classAttribute == null) {
            classAttribute = obtainStyledAttributes.getString(C0232R.styleable.FragmentContainerView_android_name);
        }
        String string = obtainStyledAttributes.getString(C0232R.styleable.FragmentContainerView_android_tag);
