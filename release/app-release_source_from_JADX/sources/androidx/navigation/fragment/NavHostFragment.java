...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    private int getContainerId() {
        int id = getId();
        if (id == 0 || id == -1) {
            return C0386R.C0389id.nav_host_fragment_container;
        }
        return id;
    }
    ...
    public void onInflate(Context context, AttributeSet attributeSet, Bundle bundle) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0386R.styleable.NavHost);
        int resourceId = obtainStyledAttributes.getResourceId(C0386R.styleable.NavHost_navGraph, 0);
        if (resourceId != 0) {
            this.mGraphId = resourceId;
        }
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0386R.styleable.NavHostFragment);
        if (obtainStyledAttributes2.getBoolean(C0386R.styleable.NavHostFragment_defaultNavHost, false)) {
            this.mDefaultNavHost = true;
        }
