...
public class ViewModelProviders {
    ...
    @Deprecated
    /* renamed from: of */
    public static ViewModelProvider m10of(FragmentActivity fragmentActivity) {
    ...
    @Deprecated
    /* renamed from: of */
    public static ViewModelProvider m11of(FragmentActivity fragmentActivity, Factory factory) {
        if (factory == null) {
