    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next != 2 || depth2 > depth || !xmlPullParser.getName().equals("item")) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet2, C0163R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0163R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0163R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0163R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0163R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0163R.styleable.ColorStateListItem_alpha, 1.0f);
                }
