...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0704R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = obtainStyledAttributes.getDimensionPixelSize(C0704R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = obtainStyledAttributes.getDimensionPixelSize(C0704R.styleable.FlowLayout_itemSpacing, 0);
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i6 = (mode == Integer.MIN_VALUE || mode == 1073741824) ? size : ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
