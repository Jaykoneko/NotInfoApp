...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C0704R.attr.snackbarStyle};
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0704R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C0704R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C0704R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C0704R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C0704R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C0704R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
    ...
    private Drawable createThemedBackground() {
        int layer = MaterialColors.layer(this.view, C0704R.attr.colorSurface, C0704R.attr.colorOnSurface, this.view.getBackgroundOverlayColorAlpha());
        float dimension = this.view.getResources().getDimension(C0704R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0704R.layout.mtrl_layout_snackbar : C0704R.layout.design_layout_snackbar;
    }
