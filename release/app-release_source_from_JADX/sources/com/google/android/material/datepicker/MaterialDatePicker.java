...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C0704R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C0704R.attr.materialCalendarStyle, C0704R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C0704R.layout.mtrl_picker_fullscreen : C0704R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C0704R.C0707id.mtrl_calendar_frame).setLayoutParams(new LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C0704R.C0707id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C0704R.C0707id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C0704R.C0707id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C0704R.C0707id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C0704R.C0707id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C0704R.C0707id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C0704R.C0707id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C0704R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C0704R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void startPickerFragment() {
        ...
        beginTransaction.replace(C0704R.C0707id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            str = checkableImageButton.getContext().getString(C0704R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            str = checkableImageButton.getContext().getString(C0704R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C0704R.C0706drawable.ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C0704R.C0706drawable.ic_edit_black_24dp));
        return stateListDrawable;
    }

    static boolean isFullscreen(Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C0704R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{16843277});
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int dimensionPixelSize = (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C0704R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C0704R.dimen.mtrl_calendar_month_vertical_padding));
        return resources.getDimensionPixelSize(C0704R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C0704R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C0704R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelSize(C0704R.dimen.mtrl_calendar_days_of_week_height) + dimensionPixelSize + resources.getDimensionPixelOffset(C0704R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C0704R.dimen.mtrl_calendar_content_padding);
        int i = Month.today().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C0704R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C0704R.dimen.mtrl_calendar_month_horizontal_padding));
    }
