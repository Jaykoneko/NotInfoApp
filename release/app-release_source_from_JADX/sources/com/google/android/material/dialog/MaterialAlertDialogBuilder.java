...
public class MaterialAlertDialogBuilder extends Builder {
    private static final int DEF_STYLE_ATTR = C0704R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0704R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0704R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C0704R.attr.colorSurface, getClass().getCanonicalName());
