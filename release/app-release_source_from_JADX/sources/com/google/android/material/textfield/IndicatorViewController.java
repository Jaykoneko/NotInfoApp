...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYPx = (float) context2.getResources().getDimensionPixelSize(C0704R.dimen.design_textinput_caption_translate_y);
    }
    ...
    private void updateCaptionViewsVisibility(int i, int i2, boolean z) {
        if (z) {
            ...
            final int i5 = i2;
            final int i6 = i;
            C08611 r0 = new AnimatorListenerAdapter() {
    ...
    public void setErrorEnabled(boolean z) {
        if (this.errorEnabled != z) {
            ...
            if (z) {
                ...
                appCompatTextView.setId(C0704R.C0707id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        if (this.helperTextEnabled != z) {
            ...
            if (z) {
                ...
                appCompatTextView.setId(C0704R.C0707id.textinput_helper_text);
                Typeface typeface2 = this.typeface;
                if (typeface2 != null) {
