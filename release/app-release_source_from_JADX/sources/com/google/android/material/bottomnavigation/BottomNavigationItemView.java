...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0704R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0704R.C0706drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0704R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0704R.C0707id.icon);
        this.smallLabel = (TextView) findViewById(C0704R.C0707id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0704R.C0707id.largeLabel);
