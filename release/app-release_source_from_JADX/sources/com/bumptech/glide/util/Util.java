...
public final class Util {
    ...
    static /* synthetic */ class C06231 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.Util.C06231.<clinit>():void");
        }
    }
    ...
    private static String bytesToHex(byte[] bArr, char[] cArr) {
        for (int i = 0; i < bArr.length; i++) {
            ...
            cArr[i2] = cArr2[b >>> 4];
            cArr[i2 + 1] = cArr2[b & TdsCore.SYBQUERY_PKT];
        }
    ...
    private static int getBytesPerPixel(Config config) {
        ...
        int i = C06231.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
