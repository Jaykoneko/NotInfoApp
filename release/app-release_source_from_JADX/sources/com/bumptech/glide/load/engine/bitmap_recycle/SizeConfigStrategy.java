...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    static /* synthetic */ class C05941 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C05941.<clinit>():void");
        }
    }
    ...
    private static Config[] getInConfigs(Config config) {
        ...
        int i = C05941.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
