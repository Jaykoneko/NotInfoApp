...
class DataCacheGenerator implements DataFetcherGenerator, DataCallback<Object> {
        ...
        while (true) {
            ...
            if (this.modelLoaders == null || !hasNextModelLoader()) {
                ...
                while (!z && hasNextModelLoader()) {
                    ...
                    this.loadData = ((ModelLoader) list.get(i2)).buildLoadData(this.cacheFile, this.helper.getWidth(), this.helper.getHeight(), this.helper.getOptions());
    ...
    public void onDataReady(Object obj) {
        this.f53cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.DATA_DISK_CACHE, this.sourceKey);
    }

    public void onLoadFailed(Exception exc) {
        this.f53cb.onDataFetcherFailed(this.sourceKey, exc, this.loadData.fetcher, DataSource.DATA_DISK_CACHE);
    }
}
