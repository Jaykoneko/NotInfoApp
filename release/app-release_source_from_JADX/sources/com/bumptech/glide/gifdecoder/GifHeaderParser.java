...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f50ix = readShort();
        this.header.currentFrame.f51iy = readShort();
        this.header.currentFrame.f49iw = readShort();
        this.header.currentFrame.f48ih = readShort();
        int read = read();
        boolean z = false;
    ...
    private int[] readColorTable(int i) {
        ...
        try {
            ...
            while (i2 < i) {
                ...
                int i6 = i5 + 1;
                int i7 = i2 + 1;
                iArr[i2] = ((bArr[i3] & 255) << TdsCore.MSLOGIN_PKT) | -16777216 | ((bArr[i4] & 255) << 8) | (bArr[i5] & 255);
                i3 = i6;
                i2 = i7;
            }
