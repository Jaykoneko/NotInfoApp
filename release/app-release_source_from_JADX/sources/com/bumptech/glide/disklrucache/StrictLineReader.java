...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f45CR = 13;

    /* renamed from: LF */
    private static final byte f46LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f47in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f47in) {
            if (this.buf != null) {
                ...
                C05791 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f47in;
        byte[] bArr = this.buf;
