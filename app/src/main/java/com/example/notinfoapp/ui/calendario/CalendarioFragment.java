package com.example.notinfoapp.ui.calendario;
...
public class CalendarioFragment extends Fragment { // Fragmento de calendario (Nueva forma de programar las tareas)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        com.example.notinfoapp.ui.calendario.CalendarioViewModel calendarioViewModel = ViewModelProviders.of(this).get(CalendarioViewModel.class);
